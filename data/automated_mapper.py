...
def map_data_sources(mapping_file_path):
    """
    ...
    with app.app_context():
        # 1. Clear existing mappings to avoid duplicates (optional, based on requirement)
...
if __name__ == "__main__":
    # Example usage with the existing file
    mapping_file = "data/insight_mapping.csv"
    map_data_sources(mapping_file)
